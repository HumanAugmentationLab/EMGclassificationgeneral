...
dir_output = 'C:\Users\saman\Google Drive\HAL\Projects\ArmEMG\Data\SEEDS\FeatureSelectionData\'; %Sam's 
...
for s = 1:length(subjectnumbers)
    load(strcat(dir_input,'subj',num2str(subjectnumbers(s),'%02.f'),fname_input,'_speed',includedspeeds{sp},'.mat'),'traindata')
    ...
    clear traindata predictors response
    save(strcat(dir_output,'subj',num2str(subjectnumbers(s),'%02.f'),fname_input,'_speed',includedspeeds{sp},'-selectionadditionsubtraction.mat'))
end
