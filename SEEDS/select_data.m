function [predictorNames] = select_data(traindata, includedfeatures, includedchannels)
...
%make includedchannels optional to add
    ...
    if isempty(includedchannels)
        ...
        idx_selfeat = contains(traindata.Properties.VariableNames,strcat('_',includedfeatures));
